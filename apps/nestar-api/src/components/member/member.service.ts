...
export class MemberService {
  ...
  private async checkSubscription(followerId: ObjectId, followingId: ObjectId): Promise<Member> {
  ...
  public async likeTargetMember(memberId: ObjectId, likeRefId: ObjectId
  ): Promise<Member> {
    //@ts-ignore
